...
public class EntityBarrett extends EntityThrowable implements IProjectile{
	...
	public EntityBarrett(World par1World) {
		super(par1World);
	...
	//		}
	//	}
	public EntityBarrett(World par1World, EntityLivingBase par2EntityLiving, float par3)
	{
		this(par1World,par2EntityLiving,par3,1.0F);
	}

	public EntityBarrett(World par1World, EntityLivingBase par2EntityLiving, float par3,float speed)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLiving;
		...
		if (movingobjectposition.entityHit != null) {
			...
			if (movingobjectposition.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.shootingEntity), ldam)) {
				...
				if (movingobjectposition.entityHit instanceof EntityLivingBase) {
					...
					// 反射
					if (this.shootingEntity != null) {
						EnchantmentThorns.func_92096_a(this.shootingEntity, lel, this.rand);
					}
			...
			if (inTile == Block.thinGlass.blockID || inTile == Block.flowerPot.blockID) {
				...
				if (Block.blocksList[inTile] instanceof BlockTNT) {
					...
					((BlockTNT)Block.blocksList[inTile]).primeTnt(worldObj, xTile, yTile, zTile, 1, this.shootingEntity);
