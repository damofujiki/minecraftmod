...
public class EntityFlyingAxe extends EntityThrowable implements IProjectile
{
	...
	public ItemStack getEntityItem()
    {
        ...
        if (itemstack == null)
        {
            ...
            {
                this.worldObj.getWorldLogAgent().logWarning("Item entity " + this.entityId + " has no item?!");
            }
...
//		}
	...
	protected void onImpact(MovingObjectPosition movingobjectposition) {
		...
		CauseDamageBoundingbox.causeDamage(null, this.worldObj, bb, (float)this.getDamage(), DamageSource.causeThrownDamage(this, shootingEntity), false);
		...
		if(isSkydrive){
			...
			if(tick==6){
				...
				if(this.target!=null){
					...
					Vec3 vecent = this.worldObj.getWorldVec3Pool().getVecFromPool(this.target.posX, this.target.posY+0.2D, this.target.posZ);
...
//		}
	...
	public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		if(this.target!=null){
			par1NBTTagCompound.setInteger("target", this.target.entityId);
		}
