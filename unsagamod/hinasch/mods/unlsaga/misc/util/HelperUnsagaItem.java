...
public class HelperUnsagaItem {
	...
	public HelperUnsagaItem(UnsagaMaterial materialItem,IIcon itemIcon,EnumUnsagaTools category){
...
//    	
    ...
    public void addInformation(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, List par3List, boolean par4) {
		...
		if(par1ItemStack!=null){
			...
			if(Unsaga.debug.get()){
				par3List.add("Weight:"+HelperUnsagaItem.getCurrentWeight(par1ItemStack));
			}
			if(!Unsaga.debug.get()){
