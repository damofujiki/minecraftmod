...
public class RenderBarrett extends Render
{
    ...
    public void doRenderBarrett(EntityBarrett par1EntityBarrett, double d, double d1, double d2, float f, float f1)
    {
		GL11.glPushMatrix();
    ...
    {
        this.doRenderBarrett((EntityBarrett)par1Entity, par2, par4, par6, par8, par9);
    }
